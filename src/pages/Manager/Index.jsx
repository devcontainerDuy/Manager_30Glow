...
function Index() {
  ...
  const [filter, setFilter] = useState({ serviceName: '', customerName: '', phone: '', time: '' });
    ...
    <>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button className="btn btn-outline-success" onClick={submitCancel}>
                  Xác nhận
                </button>
      ...
      <div className="container">
        ...
        <div className="card card-primary card-outline text-sm mb-3">
          ...
          <div className="card-body row form-group-category">
            ...
            <div className="form-group col-md-4">
              <label htmlFor="customerName" className="form-label">Họ tên khách hàng</label>
              <input
      ...
      <nav className="d-flex justify-content-center mx-auto">
        <ul className="pagination">
          ...
          <li className="page-item"><a className="page-link" href="#" rel="next">Next</a></li>
